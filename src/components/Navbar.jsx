    ...
    <nav className={`${styles.paddingX} w-full flex items-center fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
         <Link to="/" className="flex items-center gap-2" onClick={() => {
           ...
           <img src={logo} alt="logo" className="object-contain w-16 h-17" />
           <p className="text-white text-[18px] font-bold cursor-pointer flex">Nandini &nbsp;<span className="sm:block hidden">Chaudhary</span></p>
         </Link>
